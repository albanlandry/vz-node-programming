...
/**
 * Create Interactive Node Page
 * 
 * Allows users to create interactive nodes that use UI definitions
 * for user input during graph execution
 */
...
export default function CreateInteractiveNodePage() {
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100">
      <div className="container mx-auto px-4 py-8">
        <div className="mb-8">
          ...
          <h1 className="text-4xl font-bold text-gray-900 mb-2">Create Interactive Node</h1>
          <p className="text-xl text-gray-600">
            Create a new interactive node that requests user input during execution
          </p>
        </div>
